...
val MynaIcons.Filled.LetterGSquare: ImageVector
    get() {
        if (_LetterGSquare != null) {
            return _LetterGSquare!!
        }
        _LetterGSquare = ImageVector.Builder(
            name = "Filled.LetterGSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterGSquare: ImageVector? = null

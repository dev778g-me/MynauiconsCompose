...
val MynaIcons.Filled.SignalSquare: ImageVector
    get() {
        if (_SignalSquare != null) {
            return _SignalSquare!!
        }
        _SignalSquare = ImageVector.Builder(
            name = "Filled.SignalSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SignalSquare: ImageVector? = null

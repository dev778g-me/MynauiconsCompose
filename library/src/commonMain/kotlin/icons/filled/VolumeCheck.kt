...
val MynaIcons.Filled.VolumeCheck: ImageVector
    get() {
        if (_VolumeCheck != null) {
            return _VolumeCheck!!
        }
        _VolumeCheck = ImageVector.Builder(
            name = "Filled.VolumeCheck",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveToRelative(14.865f, 4.071f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.216f, -0.88f)
                lineToRelative(-2.467f, 3.417f)
                lineToRelative(-1.005f, -1.148f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.13f, 0.987f)
                lineToRelative(1.38f, 1.576f)
                curveToRelative(0.443f, 0.507f, 1.244f, 0.47f, 1.639f, -0.077f)
                close()
            }
        }.build()

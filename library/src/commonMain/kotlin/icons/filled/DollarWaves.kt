...
val MynaIcons.Filled.DollarWaves: ImageVector
    get() {
        if (_DollarWaves != null) {
            return _DollarWaves!!
        }
        _DollarWaves = ImageVector.Builder(
            name = "Filled.DollarWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DollarWaves: ImageVector? = null

...
val MynaIcons.Filled.Package: ImageVector
    get() {
        if (_Package != null) {
            return _Package!!
        }
        _Package = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(2.827f, 1.384f)
                lineToRelative(7.356f, -3.703f)
                lineToRelative(-2.465f, -1.276f)
                arcToRelative(7f, 7f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.282f, -0.141f)
                lineToRelative(-0.058f, -0.024f)
                moveToRelative(4.45f, 2.292f)
                lineToRelative(-7.31f, 3.68f)
                lineTo(12f, 11.102f)
                lineToRelative(7.332f, -3.588f)
                close()
                moveTo(11.25f, 19.766f)
                verticalLineToRelative(-7.36f)
                lineToRelative(-3f, -1.469f)
                verticalLineToRelative(1f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.5f, 0f)
                verticalLineToRelative(-1.734f)
                lineToRelative(-3f, -1.468f)

...
val MynaIcons.Filled.DotsOctagon: ImageVector
    get() {
        if (_DotsOctagon != null) {
            return _DotsOctagon!!
        }
        _DotsOctagon = ImageVector.Builder(
            name = "Filled.DotsOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsOctagon: ImageVector? = null

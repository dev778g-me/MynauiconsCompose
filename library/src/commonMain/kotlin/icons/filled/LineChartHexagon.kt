...
val MynaIcons.Filled.LineChartHexagon: ImageVector
    get() {
        if (_LineChartHexagon != null) {
            return _LineChartHexagon!!
        }
        _LineChartHexagon = ImageVector.Builder(
            name = "Filled.LineChartHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LineChartHexagon: ImageVector? = null

...
val MynaIcons.Filled.SlashHexagon: ImageVector
    get() {
        if (_SlashHexagon != null) {
            return _SlashHexagon!!
        }
        _SlashHexagon = ImageVector.Builder(
            name = "Filled.SlashHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SlashHexagon: ImageVector? = null

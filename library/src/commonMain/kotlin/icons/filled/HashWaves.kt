...
val MynaIcons.Filled.HashWaves: ImageVector
    get() {
        if (_HashWaves != null) {
            return _HashWaves!!
        }
        _HashWaves = ImageVector.Builder(
            name = "Filled.HashWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _HashWaves: ImageVector? = null

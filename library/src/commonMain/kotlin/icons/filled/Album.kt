...
val MynaIcons.Filled.Album: ImageVector
    get() {
        if (_Album != null) {
            return _Album!!
        }
        _Album = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12.25f, 2.25f)
                verticalLineTo(10f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.26f, 0.55f)
                lineTo(15f, 9.166f)
                lineToRelative(1.49f, 1.384f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.26f, -0.55f)
                verticalLineTo(2.357f)
                curveToRelative(0.518f, 0.07f, 0.978f, 0.193f, 1.407f, 0.41f)

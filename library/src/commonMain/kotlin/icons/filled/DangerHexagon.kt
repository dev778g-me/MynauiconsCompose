...
val MynaIcons.Filled.DangerHexagon: ImageVector
    get() {
        if (_DangerHexagon != null) {
            return _DangerHexagon!!
        }
        _DangerHexagon = ImageVector.Builder(
            name = "Filled.DangerHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveToRelative(0f, 5.127f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.75f, 0.75f)
                verticalLineToRelative(5.5f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.5f, 0f)
                verticalLineToRelative(-5.5f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.75f, -0.75f)
                moveToRelative(0.75f, 8.996f)
...
private var _DangerHexagon: ImageVector? = null

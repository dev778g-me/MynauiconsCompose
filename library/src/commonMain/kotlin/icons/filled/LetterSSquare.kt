...
val MynaIcons.Filled.LetterSSquare: ImageVector
    get() {
        if (_LetterSSquare != null) {
            return _LetterSSquare!!
        }
        _LetterSSquare = ImageVector.Builder(
            name = "Filled.LetterSSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterSSquare: ImageVector? = null

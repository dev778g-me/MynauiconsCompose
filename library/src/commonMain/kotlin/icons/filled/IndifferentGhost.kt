...
val MynaIcons.Filled.IndifferentGhost: ImageVector
    get() {
        if (_IndifferentGhost != null) {
            return _IndifferentGhost!!
        }
        _IndifferentGhost = ImageVector.Builder(
            name = "Filled.IndifferentGhost",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _IndifferentGhost: ImageVector? = null

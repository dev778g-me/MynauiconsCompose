...
val MynaIcons.Filled.ZeroSquare: ImageVector
    get() {
        if (_ZeroSquare != null) {
            return _ZeroSquare!!
        }
        _ZeroSquare = ImageVector.Builder(
            name = "Filled.ZeroSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ZeroSquare: ImageVector? = null

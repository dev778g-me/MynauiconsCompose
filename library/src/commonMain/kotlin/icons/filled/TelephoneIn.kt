...
val MynaIcons.Filled.TelephoneIn: ImageVector
    get() {
        if (_TelephoneIn != null) {
            return _TelephoneIn!!
        }
        _TelephoneIn = ImageVector.Builder(
            name = "Filled.TelephoneIn",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _TelephoneIn: ImageVector? = null

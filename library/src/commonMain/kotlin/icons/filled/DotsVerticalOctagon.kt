...
val MynaIcons.Filled.DotsVerticalOctagon: ImageVector
    get() {
        if (_DotsVerticalOctagon != null) {
            return _DotsVerticalOctagon!!
        }
        _DotsVerticalOctagon = ImageVector.Builder(
            name = "Filled.DotsVerticalOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsVerticalOctagon: ImageVector? = null

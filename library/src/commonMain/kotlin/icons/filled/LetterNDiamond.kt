...
val MynaIcons.Filled.LetterNDiamond: ImageVector
    get() {
        if (_LetterNDiamond != null) {
            return _LetterNDiamond!!
        }
        _LetterNDiamond = ImageVector.Builder(
            name = "Filled.LetterNDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterNDiamond: ImageVector? = null

...
val MynaIcons.Filled.ChevronUpLeftSquare: ImageVector
    get() {
        if (_ChevronUpLeftSquare != null) {
            return _ChevronUpLeftSquare!!
        }
        _ChevronUpLeftSquare = ImageVector.Builder(
            name = "Filled.ChevronUpLeftSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpLeftSquare: ImageVector? = null

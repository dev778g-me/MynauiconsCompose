...
val MynaIcons.Filled.LineChartOctagon: ImageVector
    get() {
        if (_LineChartOctagon != null) {
            return _LineChartOctagon!!
        }
        _LineChartOctagon = ImageVector.Builder(
            name = "Filled.LineChartOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LineChartOctagon: ImageVector? = null

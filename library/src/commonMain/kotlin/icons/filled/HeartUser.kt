...
val MynaIcons.Filled.HeartUser: ImageVector
    get() {
        if (_HeartUser != null) {
            return _HeartUser!!
        }
        _HeartUser = ImageVector.Builder(
            name = "Filled.HeartUser",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(2.75f, 2.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 7.75f)
            }
        }.build()
...
private var _HeartUser: ImageVector? = null

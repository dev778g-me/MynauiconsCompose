...
val MynaIcons.Filled.LetterOSquare: ImageVector
    get() {
        if (_LetterOSquare != null) {
            return _LetterOSquare!!
        }
        _LetterOSquare = ImageVector.Builder(
            name = "Filled.LetterOSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterOSquare: ImageVector? = null

...
val MynaIcons.Filled.LetterVWaves: ImageVector
    get() {
        if (_LetterVWaves != null) {
            return _LetterVWaves!!
        }
        _LetterVWaves = ImageVector.Builder(
            name = "Filled.LetterVWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterVWaves: ImageVector? = null

...
val MynaIcons.Filled.LetterIHexagon: ImageVector
    get() {
        if (_LetterIHexagon != null) {
            return _LetterIHexagon!!
        }
        _LetterIHexagon = ImageVector.Builder(
            name = "Filled.LetterIHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterIHexagon: ImageVector? = null

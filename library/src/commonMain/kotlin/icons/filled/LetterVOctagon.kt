...
val MynaIcons.Filled.LetterVOctagon: ImageVector
    get() {
        if (_LetterVOctagon != null) {
            return _LetterVOctagon!!
        }
        _LetterVOctagon = ImageVector.Builder(
            name = "Filled.LetterVOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterVOctagon: ImageVector? = null

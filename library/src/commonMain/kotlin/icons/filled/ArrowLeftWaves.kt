...
val MynaIcons.Filled.ArrowLeftWaves: ImageVector
    get() {
        if (_ArrowLeftWaves != null) {
            return _ArrowLeftWaves!!
        }
        _ArrowLeftWaves = ImageVector.Builder(
            name = "Filled.ArrowLeftWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowLeftWaves: ImageVector? = null

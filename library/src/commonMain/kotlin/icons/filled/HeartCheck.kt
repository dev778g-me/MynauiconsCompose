...
val MynaIcons.Filled.HeartCheck: ImageVector
    get() {
        if (_HeartCheck != null) {
            return _HeartCheck!!
        }
        _HeartCheck = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveToRelative(1.757f, -10.969f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.166f, 1.047f)

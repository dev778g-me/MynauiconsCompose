...
val MynaIcons.Filled.LetterKWaves: ImageVector
    get() {
        if (_LetterKWaves != null) {
            return _LetterKWaves!!
        }
        _LetterKWaves = ImageVector.Builder(
            name = "Filled.LetterKWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterKWaves: ImageVector? = null

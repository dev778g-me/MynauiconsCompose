...
val MynaIcons.Filled.WinkGhost: ImageVector
    get() {
        if (_WinkGhost != null) {
            return _WinkGhost!!
        }
        _WinkGhost = ImageVector.Builder(
            name = "Filled.WinkGhost",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _WinkGhost: ImageVector? = null

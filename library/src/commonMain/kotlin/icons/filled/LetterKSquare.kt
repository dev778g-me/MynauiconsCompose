...
val MynaIcons.Filled.LetterKSquare: ImageVector
    get() {
        if (_LetterKSquare != null) {
            return _LetterKSquare!!
        }
        _LetterKSquare = ImageVector.Builder(
            name = "Filled.LetterKSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterKSquare: ImageVector? = null

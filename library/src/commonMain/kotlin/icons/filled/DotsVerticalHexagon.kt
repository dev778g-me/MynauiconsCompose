...
val MynaIcons.Filled.DotsVerticalHexagon: ImageVector
    get() {
        if (_DotsVerticalHexagon != null) {
            return _DotsVerticalHexagon!!
        }
        _DotsVerticalHexagon = ImageVector.Builder(
            name = "Filled.DotsVerticalHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsVerticalHexagon: ImageVector? = null

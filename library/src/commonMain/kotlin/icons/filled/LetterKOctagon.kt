...
val MynaIcons.Filled.LetterKOctagon: ImageVector
    get() {
        if (_LetterKOctagon != null) {
            return _LetterKOctagon!!
        }
        _LetterKOctagon = ImageVector.Builder(
            name = "Filled.LetterKOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterKOctagon: ImageVector? = null

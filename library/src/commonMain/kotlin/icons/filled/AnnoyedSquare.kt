...
val MynaIcons.Filled.AnnoyedSquare: ImageVector
    get() {
        if (_AnnoyedSquare != null) {
            return _AnnoyedSquare!!
        }
        _AnnoyedSquare = ImageVector.Builder(
            name = "Filled.AnnoyedSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14f, 9.5f)
                horizontalLineToRelative(1f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, 1.5f)
                horizontalLineToRelative(-1f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.75f, -0.75f)
...
private var _AnnoyedSquare: ImageVector? = null

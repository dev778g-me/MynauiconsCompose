...
val MynaIcons.Filled.ChevronLeftSquare: ImageVector
    get() {
        if (_ChevronLeftSquare != null) {
            return _ChevronLeftSquare!!
        }
        _ChevronLeftSquare = ImageVector.Builder(
            name = "Filled.ChevronLeftSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronLeftSquare: ImageVector? = null

...
val MynaIcons.Filled.Triangle: ImageVector
    get() {
        if (_Triangle != null) {
            return _Triangle!!
        }
        _Triangle = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 2.25f)
                curveToRelative(-1.418f, 0f, -2.462f, 0.91f, -3.417f, 2.257f)
                curveToRelative(-0.948f, 1.338f, -1.953f, 3.318f, -3.24f, 5.853f)
                ...
                curveToRelative(-0.44f, -1.325f, -1.278f, -2.978f, -2.343f, -5.076f)
                lineToRelative(-0.39f, -0.768f)
                curveToRelative(-1.287f, -2.535f, -2.292f, -4.515f, -3.24f, -5.853f)
                curveTo(14.462f, 3.159f, 13.418f, 2.25f, 12f, 2.25f)
            }
        }.build()

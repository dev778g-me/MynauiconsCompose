...
val MynaIcons.Filled.StopWaves: ImageVector
    get() {
        if (_StopWaves != null) {
            return _StopWaves!!
        }
        _StopWaves = ImageVector.Builder(
            name = "Filled.StopWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _StopWaves: ImageVector? = null

...
val MynaIcons.Filled.LetterHSquare: ImageVector
    get() {
        if (_LetterHSquare != null) {
            return _LetterHSquare!!
        }
        _LetterHSquare = ImageVector.Builder(
            name = "Filled.LetterHSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterHSquare: ImageVector? = null

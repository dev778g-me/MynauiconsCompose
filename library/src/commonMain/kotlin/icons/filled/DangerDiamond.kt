...
val MynaIcons.Filled.DangerDiamond: ImageVector
    get() {
        if (_DangerDiamond != null) {
            return _DangerDiamond!!
        }
        _DangerDiamond = ImageVector.Builder(
            name = "Filled.DangerDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DangerDiamond: ImageVector? = null

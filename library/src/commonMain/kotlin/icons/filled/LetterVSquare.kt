...
val MynaIcons.Filled.LetterVSquare: ImageVector
    get() {
        if (_LetterVSquare != null) {
            return _LetterVSquare!!
        }
        _LetterVSquare = ImageVector.Builder(
            name = "Filled.LetterVSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterVSquare: ImageVector? = null

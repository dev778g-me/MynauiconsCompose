...
val MynaIcons.Filled.RupeeOctagon: ImageVector
    get() {
        if (_RupeeOctagon != null) {
            return _RupeeOctagon!!
        }
        _RupeeOctagon = ImageVector.Builder(
            name = "Filled.RupeeOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _RupeeOctagon: ImageVector? = null

...
val MynaIcons.Filled.Copyleft: ImageVector
    get() {
        if (_Copyleft != null) {
            return _Copyleft!!
        }
        _Copyleft = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.4f, 0.575f, -0.965f, 0.928f, -1.731f, 0.928f)
                curveToRelative(-0.652f, 0f, -1.042f, -0.254f, -1.415f, -0.72f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.17f, 0.94f)
                curveToRelative(0.587f, 0.732f, 1.377f, 1.28f, 2.585f, 1.28f)
                curveToRelative(1.32f, 0f, 2.32f, -0.647f, 2.962f, -1.572f)
                curveToRelative(0.627f, -0.902f, 0.917f, -2.06f, 0.917f, -3.178f)
                reflectiveCurveToRelative(-0.29f, -2.276f, -0.917f, -3.178f)
                curveTo(14.07f, 7.897f, 13.07f, 7.25f, 11.75f, 7.25f)

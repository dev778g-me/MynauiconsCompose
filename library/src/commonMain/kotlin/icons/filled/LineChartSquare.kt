...
val MynaIcons.Filled.LineChartSquare: ImageVector
    get() {
        if (_LineChartSquare != null) {
            return _LineChartSquare!!
        }
        _LineChartSquare = ImageVector.Builder(
            name = "Filled.LineChartSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LineChartSquare: ImageVector? = null

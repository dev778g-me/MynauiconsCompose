...
val MynaIcons.Filled.PercentageOctagon: ImageVector
    get() {
        if (_PercentageOctagon != null) {
            return _PercentageOctagon!!
        }
        _PercentageOctagon = ImageVector.Builder(
            name = "Filled.PercentageOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PercentageOctagon: ImageVector? = null

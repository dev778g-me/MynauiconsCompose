...
val MynaIcons.Filled.PauseHexagon: ImageVector
    get() {
        if (_PauseHexagon != null) {
            return _PauseHexagon!!
        }
        _PauseHexagon = ImageVector.Builder(
            name = "Filled.PauseHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PauseHexagon: ImageVector? = null

...
val MynaIcons.Filled.TwoDiamond: ImageVector
    get() {
        if (_TwoDiamond != null) {
            return _TwoDiamond!!
        }
        _TwoDiamond = ImageVector.Builder(
            name = "Filled.TwoDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _TwoDiamond: ImageVector? = null

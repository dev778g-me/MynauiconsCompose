...
val MynaIcons.Filled.LetterNSquare: ImageVector
    get() {
        if (_LetterNSquare != null) {
            return _LetterNSquare!!
        }
        _LetterNSquare = ImageVector.Builder(
            name = "Filled.LetterNSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterNSquare: ImageVector? = null

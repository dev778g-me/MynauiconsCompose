...
val MynaIcons.Filled.ChevronRightWaves: ImageVector
    get() {
        if (_ChevronRightWaves != null) {
            return _ChevronRightWaves!!
        }
        _ChevronRightWaves = ImageVector.Builder(
            name = "Filled.ChevronRightWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronRightWaves: ImageVector? = null

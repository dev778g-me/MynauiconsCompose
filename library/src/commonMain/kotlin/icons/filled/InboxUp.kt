...
val MynaIcons.Filled.InboxUp: ImageVector
    get() {
        if (_InboxUp != null) {
            return _InboxUp!!
        }
        _InboxUp = ImageVector.Builder(
            name = "Filled.InboxUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _InboxUp: ImageVector? = null

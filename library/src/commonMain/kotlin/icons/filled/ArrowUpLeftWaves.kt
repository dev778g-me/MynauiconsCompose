...
val MynaIcons.Filled.ArrowUpLeftWaves: ImageVector
    get() {
        if (_ArrowUpLeftWaves != null) {
            return _ArrowUpLeftWaves!!
        }
        _ArrowUpLeftWaves = ImageVector.Builder(
            name = "Filled.ArrowUpLeftWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowUpLeftWaves: ImageVector? = null

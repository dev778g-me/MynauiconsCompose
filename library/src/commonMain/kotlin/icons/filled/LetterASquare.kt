...
val MynaIcons.Filled.LetterASquare: ImageVector
    get() {
        if (_LetterASquare != null) {
            return _LetterASquare!!
        }
        _LetterASquare = ImageVector.Builder(
            name = "Filled.LetterASquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterASquare: ImageVector? = null

...
val MynaIcons.Filled.LetterXHexagon: ImageVector
    get() {
        if (_LetterXHexagon != null) {
            return _LetterXHexagon!!
        }
        _LetterXHexagon = ImageVector.Builder(
            name = "Filled.LetterXHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterXHexagon: ImageVector? = null

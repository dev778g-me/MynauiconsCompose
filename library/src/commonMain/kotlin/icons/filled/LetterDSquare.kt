...
val MynaIcons.Filled.LetterDSquare: ImageVector
    get() {
        if (_LetterDSquare != null) {
            return _LetterDSquare!!
        }
        _LetterDSquare = ImageVector.Builder(
            name = "Filled.LetterDSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterDSquare: ImageVector? = null

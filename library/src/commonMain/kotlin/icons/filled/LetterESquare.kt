...
val MynaIcons.Filled.LetterESquare: ImageVector
    get() {
        if (_LetterESquare != null) {
            return _LetterESquare!!
        }
        _LetterESquare = ImageVector.Builder(
            name = "Filled.LetterESquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterESquare: ImageVector? = null

...
val MynaIcons.Filled.LetterAHexagon: ImageVector
    get() {
        if (_LetterAHexagon != null) {
            return _LetterAHexagon!!
        }
        _LetterAHexagon = ImageVector.Builder(
            name = "Filled.LetterAHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterAHexagon: ImageVector? = null

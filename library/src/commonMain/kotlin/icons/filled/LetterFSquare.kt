...
val MynaIcons.Filled.LetterFSquare: ImageVector
    get() {
        if (_LetterFSquare != null) {
            return _LetterFSquare!!
        }
        _LetterFSquare = ImageVector.Builder(
            name = "Filled.LetterFSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterFSquare: ImageVector? = null

...
val MynaIcons.Filled.DangerOctagon: ImageVector
    get() {
        if (_DangerOctagon != null) {
            return _DangerOctagon!!
        }
        _DangerOctagon = ImageVector.Builder(
            name = "Filled.DangerOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DangerOctagon: ImageVector? = null

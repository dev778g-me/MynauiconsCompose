...
val MynaIcons.Filled.DotsVerticalWaves: ImageVector
    get() {
        if (_DotsVerticalWaves != null) {
            return _DotsVerticalWaves!!
        }
        _DotsVerticalWaves = ImageVector.Builder(
            name = "Filled.DotsVerticalWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsVerticalWaves: ImageVector? = null

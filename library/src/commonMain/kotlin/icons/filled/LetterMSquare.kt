...
val MynaIcons.Filled.LetterMSquare: ImageVector
    get() {
        if (_LetterMSquare != null) {
            return _LetterMSquare!!
        }
        _LetterMSquare = ImageVector.Builder(
            name = "Filled.LetterMSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterMSquare: ImageVector? = null

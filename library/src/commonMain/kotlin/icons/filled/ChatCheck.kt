...
val MynaIcons.Filled.ChatCheck: ImageVector
    get() {
        if (_ChatCheck != null) {
            return _ChatCheck!!
        }
        _ChatCheck = ImageVector.Builder(
            name = "Filled.ChatCheck",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.128f, -0.987f)

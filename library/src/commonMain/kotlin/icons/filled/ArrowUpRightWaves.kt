...
val MynaIcons.Filled.ArrowUpRightWaves: ImageVector
    get() {
        if (_ArrowUpRightWaves != null) {
            return _ArrowUpRightWaves!!
        }
        _ArrowUpRightWaves = ImageVector.Builder(
            name = "Filled.ArrowUpRightWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowUpRightWaves: ImageVector? = null

...
val MynaIcons.Filled.LetterIOctagon: ImageVector
    get() {
        if (_LetterIOctagon != null) {
            return _LetterIOctagon!!
        }
        _LetterIOctagon = ImageVector.Builder(
            name = "Filled.LetterIOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterIOctagon: ImageVector? = null

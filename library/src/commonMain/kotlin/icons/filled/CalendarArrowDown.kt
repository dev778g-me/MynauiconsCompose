...
val MynaIcons.Filled.CalendarArrowDown: ImageVector
    get() {
        ...
        _CalendarArrowDown = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveToRelative(7.243f, 6.413f)
                lineToRelative(-0.002f, 4.109f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.092f, 0f)
                lineToRelative(-2.5f, -2.653f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.092f, -1.029f)
                lineToRelative(1.205f, 1.279f)
                lineToRelative(0.002f, -4.112f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = true, 1.5f, 0.002f)
            }
        }.build()

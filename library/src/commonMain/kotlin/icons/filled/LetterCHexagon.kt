...
val MynaIcons.Filled.LetterCHexagon: ImageVector
    get() {
        if (_LetterCHexagon != null) {
            return _LetterCHexagon!!
        }
        _LetterCHexagon = ImageVector.Builder(
            name = "Filled.LetterCHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterCHexagon: ImageVector? = null

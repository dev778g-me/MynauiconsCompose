...
val MynaIcons.Filled.DotsWaves: ImageVector
    get() {
        if (_DotsWaves != null) {
            return _DotsWaves!!
        }
        _DotsWaves = ImageVector.Builder(
            name = "Filled.DotsWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsWaves: ImageVector? = null

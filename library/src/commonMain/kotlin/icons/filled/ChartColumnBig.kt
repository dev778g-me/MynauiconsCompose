    ...
    get() {
        ...
        _ChartColumnBig = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(13.75f, 16f)
                lineTo(13.75f, 7f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 16f, 4.75f)
                horizontalLineToRelative(1f)
                lineToRelative(0.23f, 0.012f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 19.25f, 7f)
                close()
                moveTo(12.25f, 16f)
                lineTo(12.238f, 16.23f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.008f, 2.008f)
                lineToRelative(-0.23f, 0.012f)
                lineTo(9f, 18.25f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.238f, -2.02f)
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 9f, 8.75f)
                horizontalLineToRelative(1f)
                lineToRelative(0.23f, 0.012f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12.25f, 11f)
                close()
            }
        }.build()

...
val MynaIcons.Filled.LetterCSquare: ImageVector
    get() {
        if (_LetterCSquare != null) {
            return _LetterCSquare!!
        }
        _LetterCSquare = ImageVector.Builder(
            name = "Filled.LetterCSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterCSquare: ImageVector? = null

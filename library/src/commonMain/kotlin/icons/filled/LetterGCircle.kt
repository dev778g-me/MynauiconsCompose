...
val MynaIcons.Filled.LetterGCircle: ImageVector
    get() {
        if (_LetterGCircle != null) {
            return _LetterGCircle!!
        }
        _LetterGCircle = ImageVector.Builder(
            name = "Filled.LetterGCircle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterGCircle: ImageVector? = null

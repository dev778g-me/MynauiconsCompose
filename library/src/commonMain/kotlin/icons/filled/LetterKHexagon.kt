...
val MynaIcons.Filled.LetterKHexagon: ImageVector
    get() {
        if (_LetterKHexagon != null) {
            return _LetterKHexagon!!
        }
        _LetterKHexagon = ImageVector.Builder(
            name = "Filled.LetterKHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterKHexagon: ImageVector? = null

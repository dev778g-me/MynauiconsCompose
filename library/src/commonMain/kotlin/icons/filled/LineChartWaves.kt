...
val MynaIcons.Filled.LineChartWaves: ImageVector
    get() {
        if (_LineChartWaves != null) {
            return _LineChartWaves!!
        }
        _LineChartWaves = ImageVector.Builder(
            name = "Filled.LineChartWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LineChartWaves: ImageVector? = null

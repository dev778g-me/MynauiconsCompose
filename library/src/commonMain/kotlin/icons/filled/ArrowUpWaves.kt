...
val MynaIcons.Filled.ArrowUpWaves: ImageVector
    get() {
        if (_ArrowUpWaves != null) {
            return _ArrowUpWaves!!
        }
        _ArrowUpWaves = ImageVector.Builder(
            name = "Filled.ArrowUpWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowUpWaves: ImageVector? = null

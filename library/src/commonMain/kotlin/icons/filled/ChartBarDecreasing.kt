...
val MynaIcons.Filled.ChartBarDecreasing: ImageVector
    get() {
        if (_ChartBarDecreasing != null) {
            return _ChartBarDecreasing!!
        }
        _ChartBarDecreasing = ImageVector.Builder(
            name = "Filled.ChartBarDecreasing",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f

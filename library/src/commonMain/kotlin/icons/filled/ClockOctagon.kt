...
val MynaIcons.Filled.ClockOctagon: ImageVector
    get() {
        if (_ClockOctagon != null) {
            return _ClockOctagon!!
        }
        _ClockOctagon = ImageVector.Builder(
            name = "Filled.ClockOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ClockOctagon: ImageVector? = null

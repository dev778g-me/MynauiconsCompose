    ...
    get() {
        ...
        _TelephoneOut = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(-0.111f, -0.15f, -0.214f, -0.287f, -0.3f, -0.41f)
            }
        }.build()

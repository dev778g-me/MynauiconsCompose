...
val MynaIcons.Filled.DotsDiamond: ImageVector
    get() {
        if (_DotsDiamond != null) {
            return _DotsDiamond!!
        }
        _DotsDiamond = ImageVector.Builder(
            name = "Filled.DotsDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _DotsDiamond: ImageVector? = null

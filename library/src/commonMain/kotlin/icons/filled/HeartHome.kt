...
val MynaIcons.Filled.HeartHome: ImageVector
    get() {
        if (_HeartHome != null) {
            return _HeartHome!!
        }
        _HeartHome = ImageVector.Builder(
            name = "Filled.HeartHome",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-0.021f, 0.015f)
                close()
                moveTo(14.692f, 10.534f)
                lineTo(12.442f, 8.894f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.884f, 0f)
                lineToRelative(-2.25f, 1.64f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9f, 11.14f)
                verticalLineToRelative(2.36f)
                curveToRelative(0f, 0.966f, 0.784f, 1.75f, 1.75f, 1.75f)
                horizontalLineToRelative(2.5f)
                arcTo(1.75f, 1.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15f, 13.5f)
                verticalLineToRelative(-2.36f)
...
private var _HeartHome: ImageVector? = null

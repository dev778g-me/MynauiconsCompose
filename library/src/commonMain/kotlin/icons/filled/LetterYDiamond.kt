...
val MynaIcons.Filled.LetterYDiamond: ImageVector
    get() {
        if (_LetterYDiamond != null) {
            return _LetterYDiamond!!
        }
        _LetterYDiamond = ImageVector.Builder(
            name = "Filled.LetterYDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterYDiamond: ImageVector? = null

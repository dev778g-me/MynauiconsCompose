    ...
    get() {
        ...
        _ChartBarStacked = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.25f, 8.5f)
                verticalLineToRelative(-1f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 8.5f, 5.25f)
                horizontalLineToRelative(9f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.25f, 2.25f)
                close()
                moveTo(14.25f, 14.5f)

...
val MynaIcons.Filled.LetterAWaves: ImageVector
    get() {
        if (_LetterAWaves != null) {
            return _LetterAWaves!!
        }
        _LetterAWaves = ImageVector.Builder(
            name = "Filled.LetterAWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterAWaves: ImageVector? = null

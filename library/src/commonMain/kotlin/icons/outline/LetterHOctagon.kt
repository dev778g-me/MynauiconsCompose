...
val MynaIcons.Outline.LetterHOctagon: ImageVector
    get() {
        if (_LetterHOctagon != null) {
            return _LetterHOctagon!!
        }
        _LetterHOctagon = ImageVector.Builder(
            name = "Outline.LetterHOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterHOctagon: ImageVector? = null

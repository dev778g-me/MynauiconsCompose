...
val MynaIcons.Outline.ChevronLeftWaves: ImageVector
    get() {
        if (_ChevronLeftWaves != null) {
            return _ChevronLeftWaves!!
        }
        _ChevronLeftWaves = ImageVector.Builder(
            name = "Outline.ChevronLeftWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronLeftWaves: ImageVector? = null

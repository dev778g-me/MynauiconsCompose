...
val MynaIcons.Outline.LetterAOctagon: ImageVector
    get() {
        if (_LetterAOctagon != null) {
            return _LetterAOctagon!!
        }
        _LetterAOctagon = ImageVector.Builder(
            name = "Outline.LetterAOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterAOctagon: ImageVector? = null

...
val MynaIcons.Outline.PanelBottomInactive: ImageVector
    get() {
        if (_PanelBottomInactive != null) {
            return _PanelBottomInactive!!
        }
        _PanelBottomInactive = ImageVector.Builder(
            name = "Outline.PanelBottomInactive",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PanelBottomInactive: ImageVector? = null

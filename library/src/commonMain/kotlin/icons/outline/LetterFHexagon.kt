...
val MynaIcons.Outline.LetterFHexagon: ImageVector
    get() {
        if (_LetterFHexagon != null) {
            return _LetterFHexagon!!
        }
        _LetterFHexagon = ImageVector.Builder(
            name = "Outline.LetterFHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterFHexagon: ImageVector? = null

...
val MynaIcons.Outline.IndifferentSquare: ImageVector
    get() {
        if (_IndifferentSquare != null) {
            return _IndifferentSquare!!
        }
        _IndifferentSquare = ImageVector.Builder(
            name = "Outline.IndifferentSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _IndifferentSquare: ImageVector? = null

...
val MynaIcons.Outline.CheckWaves: ImageVector
    get() {
        if (_CheckWaves != null) {
            return _CheckWaves!!
        }
        _CheckWaves = ImageVector.Builder(
            name = "Outline.CheckWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveToRelative(8.667f, 12.633f)
                lineToRelative(1.505f, 1.721f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.564f, -0.073f)
                lineTo(15.333f, 9.3f)
            }
        }.build()
...
private var _CheckWaves: ImageVector? = null

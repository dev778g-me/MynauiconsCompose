...
val MynaIcons.Outline.LetterWSquare: ImageVector
    get() {
        if (_LetterWSquare != null) {
            return _LetterWSquare!!
        }
        _LetterWSquare = ImageVector.Builder(
            name = "Outline.LetterWSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterWSquare: ImageVector? = null

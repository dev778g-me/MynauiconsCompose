...
val MynaIcons.Outline.LetterYSquare: ImageVector
    get() {
        if (_LetterYSquare != null) {
            return _LetterYSquare!!
        }
        _LetterYSquare = ImageVector.Builder(
            name = "Outline.LetterYSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterYSquare: ImageVector? = null

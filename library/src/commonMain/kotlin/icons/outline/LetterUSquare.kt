...
val MynaIcons.Outline.LetterUSquare: ImageVector
    get() {
        if (_LetterUSquare != null) {
            return _LetterUSquare!!
        }
        _LetterUSquare = ImageVector.Builder(
            name = "Outline.LetterUSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterUSquare: ImageVector? = null

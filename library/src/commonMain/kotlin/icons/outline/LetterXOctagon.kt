...
val MynaIcons.Outline.LetterXOctagon: ImageVector
    get() {
        if (_LetterXOctagon != null) {
            return _LetterXOctagon!!
        }
        _LetterXOctagon = ImageVector.Builder(
            name = "Outline.LetterXOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterXOctagon: ImageVector? = null

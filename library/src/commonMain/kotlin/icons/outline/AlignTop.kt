...
val MynaIcons.Outline.AlignTop: ImageVector
    get() {
        if (_AlignTop != null) {
            return _AlignTop!!
        }
        _AlignTop = ImageVector.Builder(
            name = "Outline.AlignTop",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveTo(8.398f, 7f, 7.932f, 7f, 7f, 7f)
                reflectiveCurveToRelative(-1.398f, 0f, -1.765f, 0.152f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.083f, 1.083f)
                curveTo(4f, 8.602f, 4f, 9.068f, 4f, 10f)
                verticalLineToRelative(8f)
                curveToRelative(0f, 0.932f, 0f, 1.398f, 0.152f, 1.765f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.083f, 1.083f)
                curveTo(5.602f, 21f, 6.068f, 21f, 7f, 21f)
                reflectiveCurveToRelative(1.398f, 0f, 1.765f, -0.152f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.083f, -1.083f)
                curveTo(10f, 19.398f, 10f, 18.932f, 10f, 18f)

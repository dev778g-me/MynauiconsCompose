...
val MynaIcons.Outline.LetterOOctagon: ImageVector
    get() {
        if (_LetterOOctagon != null) {
            return _LetterOOctagon!!
        }
        _LetterOOctagon = ImageVector.Builder(
            name = "Outline.LetterOOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterOOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterXWaves: ImageVector
    get() {
        if (_LetterXWaves != null) {
            return _LetterXWaves!!
        }
        _LetterXWaves = ImageVector.Builder(
            name = "Outline.LetterXWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterXWaves: ImageVector? = null

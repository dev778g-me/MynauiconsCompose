...
val MynaIcons.Outline.LetterZHexagon: ImageVector
    get() {
        if (_LetterZHexagon != null) {
            return _LetterZHexagon!!
        }
        _LetterZHexagon = ImageVector.Builder(
            name = "Outline.LetterZHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterZHexagon: ImageVector? = null

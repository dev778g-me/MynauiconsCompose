...
val MynaIcons.Outline.ChevronDownRightSquare: ImageVector
    get() {
        if (_ChevronDownRightSquare != null) {
            return _ChevronDownRightSquare!!
        }
        _ChevronDownRightSquare = ImageVector.Builder(
            name = "Outline.ChevronDownRightSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownRightSquare: ImageVector? = null

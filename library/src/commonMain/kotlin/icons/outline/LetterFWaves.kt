...
val MynaIcons.Outline.LetterFWaves: ImageVector
    get() {
        if (_LetterFWaves != null) {
            return _LetterFWaves!!
        }
        _LetterFWaves = ImageVector.Builder(
            name = "Outline.LetterFWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterFWaves: ImageVector? = null

...
val MynaIcons.Outline.ZeroOctagon: ImageVector
    get() {
        if (_ZeroOctagon != null) {
            return _ZeroOctagon!!
        }
        _ZeroOctagon = ImageVector.Builder(
            name = "Outline.ZeroOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ZeroOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterRHexagon: ImageVector
    get() {
        if (_LetterRHexagon != null) {
            return _LetterRHexagon!!
        }
        _LetterRHexagon = ImageVector.Builder(
            name = "Outline.LetterRHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterRHexagon: ImageVector? = null

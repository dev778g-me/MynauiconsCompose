...
val MynaIcons.Outline.LetterMWaves: ImageVector
    get() {
        if (_LetterMWaves != null) {
            return _LetterMWaves!!
        }
        _LetterMWaves = ImageVector.Builder(
            name = "Outline.LetterMWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterMWaves: ImageVector? = null

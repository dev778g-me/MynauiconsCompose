...
val MynaIcons.Outline.ChevronUpWaves: ImageVector
    get() {
        if (_ChevronUpWaves != null) {
            return _ChevronUpWaves!!
        }
        _ChevronUpWaves = ImageVector.Builder(
            name = "Outline.ChevronUpWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpWaves: ImageVector? = null

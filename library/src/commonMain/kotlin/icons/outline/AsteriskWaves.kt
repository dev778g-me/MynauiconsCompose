...
val MynaIcons.Outline.AsteriskWaves: ImageVector
    get() {
        if (_AsteriskWaves != null) {
            return _AsteriskWaves!!
        }
        _AsteriskWaves = ImageVector.Builder(
            name = "Outline.AsteriskWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _AsteriskWaves: ImageVector? = null

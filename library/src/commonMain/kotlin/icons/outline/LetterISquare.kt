...
val MynaIcons.Outline.LetterISquare: ImageVector
    get() {
        if (_LetterISquare != null) {
            return _LetterISquare!!
        }
        _LetterISquare = ImageVector.Builder(
            name = "Outline.LetterISquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterISquare: ImageVector? = null

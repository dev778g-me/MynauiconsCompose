...
val MynaIcons.Outline.LetterIWaves: ImageVector
    get() {
        if (_LetterIWaves != null) {
            return _LetterIWaves!!
        }
        _LetterIWaves = ImageVector.Builder(
            name = "Outline.LetterIWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterIWaves: ImageVector? = null

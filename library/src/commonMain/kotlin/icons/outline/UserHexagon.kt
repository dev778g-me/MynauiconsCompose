...
val MynaIcons.Outline.UserHexagon: ImageVector
    get() {
        if (_UserHexagon != null) {
            return _UserHexagon!!
        }
        _UserHexagon = ImageVector.Builder(
            name = "Outline.UserHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveToRelative(-7.454f, 9.455f)
                curveToRelative(0.756f, -5.527f, 9.152f, -5.527f, 9.908f, 0f)
            }
        }.build()

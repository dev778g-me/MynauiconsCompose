...
val MynaIcons.Outline.LetterOWaves: ImageVector
    get() {
        if (_LetterOWaves != null) {
            return _LetterOWaves!!
        }
        _LetterOWaves = ImageVector.Builder(
            name = "Outline.LetterOWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterOWaves: ImageVector? = null

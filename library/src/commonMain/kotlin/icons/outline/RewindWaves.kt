...
val MynaIcons.Outline.RewindWaves: ImageVector
    get() {
        if (_RewindWaves != null) {
            return _RewindWaves!!
        }
        _RewindWaves = ImageVector.Builder(
            name = "Outline.RewindWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _RewindWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterSWaves: ImageVector
    get() {
        if (_LetterSWaves != null) {
            return _LetterSWaves!!
        }
        _LetterSWaves = ImageVector.Builder(
            name = "Outline.LetterSWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterSWaves: ImageVector? = null

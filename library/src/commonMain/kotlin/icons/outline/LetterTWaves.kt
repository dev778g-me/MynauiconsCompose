...
val MynaIcons.Outline.LetterTWaves: ImageVector
    get() {
        if (_LetterTWaves != null) {
            return _LetterTWaves!!
        }
        _LetterTWaves = ImageVector.Builder(
            name = "Outline.LetterTWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterTWaves: ImageVector? = null

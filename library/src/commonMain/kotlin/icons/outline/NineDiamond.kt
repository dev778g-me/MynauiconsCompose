...
val MynaIcons.Outline.NineDiamond: ImageVector
    get() {
        if (_NineDiamond != null) {
            return _NineDiamond!!
        }
        _NineDiamond = ImageVector.Builder(
            name = "Outline.NineDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _NineDiamond: ImageVector? = null

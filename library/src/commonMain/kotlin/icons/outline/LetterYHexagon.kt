...
val MynaIcons.Outline.LetterYHexagon: ImageVector
    get() {
        if (_LetterYHexagon != null) {
            return _LetterYHexagon!!
        }
        _LetterYHexagon = ImageVector.Builder(
            name = "Outline.LetterYHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterYHexagon: ImageVector? = null

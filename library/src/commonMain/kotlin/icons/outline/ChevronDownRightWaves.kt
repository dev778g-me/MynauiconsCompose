...
val MynaIcons.Outline.ChevronDownRightWaves: ImageVector
    get() {
        if (_ChevronDownRightWaves != null) {
            return _ChevronDownRightWaves!!
        }
        _ChevronDownRightWaves = ImageVector.Builder(
            name = "Outline.ChevronDownRightWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownRightWaves: ImageVector? = null

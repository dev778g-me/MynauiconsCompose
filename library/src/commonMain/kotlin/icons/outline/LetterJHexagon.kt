...
val MynaIcons.Outline.LetterJHexagon: ImageVector
    get() {
        if (_LetterJHexagon != null) {
            return _LetterJHexagon!!
        }
        _LetterJHexagon = ImageVector.Builder(
            name = "Outline.LetterJHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterJHexagon: ImageVector? = null

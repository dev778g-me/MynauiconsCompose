...
val MynaIcons.Outline.CreditCard: ImageVector
    get() {
        if (_CreditCard != null) {
            return _CreditCard!!
        }
        _CreditCard = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(1.12f, 0f, 1.68f, 0f, 2.107f, 0.218f)
                curveToRelative(0.377f, 0.192f, 0.683f, 0.497f, 0.875f, 0.874f)
                curveToRelative(0.218f, 0.427f, 0.218f, 0.987f, 0.218f, 2.105f)
                verticalLineTo(9f)
                moveTo(3f, 9f)

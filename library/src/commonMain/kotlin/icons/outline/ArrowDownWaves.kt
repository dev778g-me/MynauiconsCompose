...
val MynaIcons.Outline.ArrowDownWaves: ImageVector
    get() {
        if (_ArrowDownWaves != null) {
            return _ArrowDownWaves!!
        }
        _ArrowDownWaves = ImageVector.Builder(
            name = "Outline.ArrowDownWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowDownWaves: ImageVector? = null

...
val MynaIcons.Outline.Instagram: ImageVector
    get() {
        if (_Instagram != null) {
            return _Instagram!!
        }
        _Instagram = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(15.462f, 11.487f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, -6.925f, 1.026f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.925f, -1.026f)
            }
        }.build()

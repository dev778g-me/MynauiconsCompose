...
val MynaIcons.Outline.MusicOctagon: ImageVector
    get() {
        if (_MusicOctagon != null) {
            return _MusicOctagon!!
        }
        _MusicOctagon = ImageVector.Builder(
            name = "Outline.MusicOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _MusicOctagon: ImageVector? = null

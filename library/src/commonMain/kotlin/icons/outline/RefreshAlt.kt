...
val MynaIcons.Outline.RefreshAlt: ImageVector
    get() {
        if (_RefreshAlt != null) {
            return _RefreshAlt!!
        }
        _RefreshAlt = ImageVector.Builder(
            name = "Outline.RefreshAlt",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(20.5f, 16f)
                curveToRelative(-1.392f, 3.179f, -4.823f, 5f, -8.522f, 5f)
                curveTo(7.299f, 21f, 3.453f, 17.448f, 3f, 12.9f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 1.5f,
                ...
                moveTo(16.489f, 15.6f)
                horizontalLineToRelative(3.97f)
                arcToRelative(0.54f, 0.54f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.541f, 0.54f)

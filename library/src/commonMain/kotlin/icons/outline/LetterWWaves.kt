...
val MynaIcons.Outline.LetterWWaves: ImageVector
    get() {
        if (_LetterWWaves != null) {
            return _LetterWWaves!!
        }
        _LetterWWaves = ImageVector.Builder(
            name = "Outline.LetterWWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterWWaves: ImageVector? = null

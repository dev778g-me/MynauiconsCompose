...
val MynaIcons.Outline.LetterRSquare: ImageVector
    get() {
        if (_LetterRSquare != null) {
            return _LetterRSquare!!
        }
        _LetterRSquare = ImageVector.Builder(
            name = "Outline.LetterRSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterRSquare: ImageVector? = null

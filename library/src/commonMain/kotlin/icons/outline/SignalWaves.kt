...
val MynaIcons.Outline.SignalWaves: ImageVector
    get() {
        if (_SignalWaves != null) {
            return _SignalWaves!!
        }
        _SignalWaves = ImageVector.Builder(
            name = "Outline.SignalWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SignalWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterYOctagon: ImageVector
    get() {
        if (_LetterYOctagon != null) {
            return _LetterYOctagon!!
        }
        _LetterYOctagon = ImageVector.Builder(
            name = "Outline.LetterYOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterYOctagon: ImageVector? = null

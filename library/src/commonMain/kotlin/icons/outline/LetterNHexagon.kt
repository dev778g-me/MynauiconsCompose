...
val MynaIcons.Outline.LetterNHexagon: ImageVector
    get() {
        if (_LetterNHexagon != null) {
            return _LetterNHexagon!!
        }
        _LetterNHexagon = ImageVector.Builder(
            name = "Outline.LetterNHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterNHexagon: ImageVector? = null

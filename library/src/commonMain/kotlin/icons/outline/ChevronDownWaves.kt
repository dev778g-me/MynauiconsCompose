...
val MynaIcons.Outline.ChevronDownWaves: ImageVector
    get() {
        if (_ChevronDownWaves != null) {
            return _ChevronDownWaves!!
        }
        _ChevronDownWaves = ImageVector.Builder(
            name = "Outline.ChevronDownWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownWaves: ImageVector? = null

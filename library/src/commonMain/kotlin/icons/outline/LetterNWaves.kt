...
val MynaIcons.Outline.LetterNWaves: ImageVector
    get() {
        if (_LetterNWaves != null) {
            return _LetterNWaves!!
        }
        _LetterNWaves = ImageVector.Builder(
            name = "Outline.LetterNWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterNWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterBWaves: ImageVector
    get() {
        if (_LetterBWaves != null) {
            return _LetterBWaves!!
        }
        _LetterBWaves = ImageVector.Builder(
            name = "Outline.LetterBWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterBWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterGWaves: ImageVector
    get() {
        if (_LetterGWaves != null) {
            return _LetterGWaves!!
        }
        _LetterGWaves = ImageVector.Builder(
            name = "Outline.LetterGWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterGWaves: ImageVector? = null

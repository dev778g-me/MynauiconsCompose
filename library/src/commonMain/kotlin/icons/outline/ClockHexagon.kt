...
val MynaIcons.Outline.ClockHexagon: ImageVector
    get() {
        if (_ClockHexagon != null) {
            return _ClockHexagon!!
        }
        _ClockHexagon = ImageVector.Builder(
            name = "Outline.ClockHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ClockHexagon: ImageVector? = null

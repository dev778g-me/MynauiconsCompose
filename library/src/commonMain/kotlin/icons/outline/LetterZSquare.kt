...
val MynaIcons.Outline.LetterZSquare: ImageVector
    get() {
        if (_LetterZSquare != null) {
            return _LetterZSquare!!
        }
        _LetterZSquare = ImageVector.Builder(
            name = "Outline.LetterZSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterZSquare: ImageVector? = null

...
val MynaIcons.Outline.LetterZWaves: ImageVector
    get() {
        if (_LetterZWaves != null) {
            return _LetterZWaves!!
        }
        _LetterZWaves = ImageVector.Builder(
            name = "Outline.LetterZWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterZWaves: ImageVector? = null

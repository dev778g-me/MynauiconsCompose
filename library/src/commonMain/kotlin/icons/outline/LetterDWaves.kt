...
val MynaIcons.Outline.LetterDWaves: ImageVector
    get() {
        if (_LetterDWaves != null) {
            return _LetterDWaves!!
        }
        _LetterDWaves = ImageVector.Builder(
            name = "Outline.LetterDWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterDWaves: ImageVector? = null

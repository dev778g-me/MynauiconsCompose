...
val MynaIcons.Outline.LetterUOctagon: ImageVector
    get() {
        if (_LetterUOctagon != null) {
            return _LetterUOctagon!!
        }
        _LetterUOctagon = ImageVector.Builder(
            name = "Outline.LetterUOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterUOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterMOctagon: ImageVector
    get() {
        if (_LetterMOctagon != null) {
            return _LetterMOctagon!!
        }
        _LetterMOctagon = ImageVector.Builder(
            name = "Outline.LetterMOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterMOctagon: ImageVector? = null

...
val MynaIcons.Outline.ChevronUpSquare: ImageVector
    get() {
        if (_ChevronUpSquare != null) {
            return _ChevronUpSquare!!
        }
        _ChevronUpSquare = ImageVector.Builder(
            name = "Outline.ChevronUpSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpSquare: ImageVector? = null

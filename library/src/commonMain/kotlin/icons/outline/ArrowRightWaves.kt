...
val MynaIcons.Outline.ArrowRightWaves: ImageVector
    get() {
        if (_ArrowRightWaves != null) {
            return _ArrowRightWaves!!
        }
        _ArrowRightWaves = ImageVector.Builder(
            name = "Outline.ArrowRightWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ArrowRightWaves: ImageVector? = null

...
val MynaIcons.Outline.ChevronDownLeftSquare: ImageVector
    get() {
        if (_ChevronDownLeftSquare != null) {
            return _ChevronDownLeftSquare!!
        }
        _ChevronDownLeftSquare = ImageVector.Builder(
            name = "Outline.ChevronDownLeftSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownLeftSquare: ImageVector? = null

...
val MynaIcons.Outline.LetterQOctagon: ImageVector
    get() {
        if (_LetterQOctagon != null) {
            return _LetterQOctagon!!
        }
        _LetterQOctagon = ImageVector.Builder(
            name = "Outline.LetterQOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterQOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterLSquare: ImageVector
    get() {
        if (_LetterLSquare != null) {
            return _LetterLSquare!!
        }
        _LetterLSquare = ImageVector.Builder(
            name = "Outline.LetterLSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterLSquare: ImageVector? = null

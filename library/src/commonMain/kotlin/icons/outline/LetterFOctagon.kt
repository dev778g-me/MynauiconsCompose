...
val MynaIcons.Outline.LetterFOctagon: ImageVector
    get() {
        if (_LetterFOctagon != null) {
            return _LetterFOctagon!!
        }
        _LetterFOctagon = ImageVector.Builder(
            name = "Outline.LetterFOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterFOctagon: ImageVector? = null

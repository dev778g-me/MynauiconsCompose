...
val MynaIcons.Outline.LetterYWaves: ImageVector
    get() {
        if (_LetterYWaves != null) {
            return _LetterYWaves!!
        }
        _LetterYWaves = ImageVector.Builder(
            name = "Outline.LetterYWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterYWaves: ImageVector? = null

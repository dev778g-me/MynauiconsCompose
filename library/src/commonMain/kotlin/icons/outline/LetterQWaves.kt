...
val MynaIcons.Outline.LetterQWaves: ImageVector
    get() {
        if (_LetterQWaves != null) {
            return _LetterQWaves!!
        }
        _LetterQWaves = ImageVector.Builder(
            name = "Outline.LetterQWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterQWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterRWaves: ImageVector
    get() {
        if (_LetterRWaves != null) {
            return _LetterRWaves!!
        }
        _LetterRWaves = ImageVector.Builder(
            name = "Outline.LetterRWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterRWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterLOctagon: ImageVector
    get() {
        if (_LetterLOctagon != null) {
            return _LetterLOctagon!!
        }
        _LetterLOctagon = ImageVector.Builder(
            name = "Outline.LetterLOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterLOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterNOctagon: ImageVector
    get() {
        if (_LetterNOctagon != null) {
            return _LetterNOctagon!!
        }
        _LetterNOctagon = ImageVector.Builder(
            name = "Outline.LetterNOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterNOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterLWaves: ImageVector
    get() {
        if (_LetterLWaves != null) {
            return _LetterLWaves!!
        }
        _LetterLWaves = ImageVector.Builder(
            name = "Outline.LetterLWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterLWaves: ImageVector? = null

...
val MynaIcons.Outline.ChevronUpRightSquare: ImageVector
    get() {
        if (_ChevronUpRightSquare != null) {
            return _ChevronUpRightSquare!!
        }
        _ChevronUpRightSquare = ImageVector.Builder(
            name = "Outline.ChevronUpRightSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpRightSquare: ImageVector? = null

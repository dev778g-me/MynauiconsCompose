...
val MynaIcons.Outline.BitcoinOctagon: ImageVector
    get() {
        if (_BitcoinOctagon != null) {
            return _BitcoinOctagon!!
        }
        _BitcoinOctagon = ImageVector.Builder(
            name = "Outline.BitcoinOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _BitcoinOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterHWaves: ImageVector
    get() {
        if (_LetterHWaves != null) {
            return _LetterHWaves!!
        }
        _LetterHWaves = ImageVector.Builder(
            name = "Outline.LetterHWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterHWaves: ImageVector? = null

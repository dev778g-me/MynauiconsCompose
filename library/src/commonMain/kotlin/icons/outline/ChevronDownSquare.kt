...
val MynaIcons.Outline.ChevronDownSquare: ImageVector
    get() {
        if (_ChevronDownSquare != null) {
            return _ChevronDownSquare!!
        }
        _ChevronDownSquare = ImageVector.Builder(
            name = "Outline.ChevronDownSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownSquare: ImageVector? = null

...
val MynaIcons.Outline.LetterUHexagon: ImageVector
    get() {
        if (_LetterUHexagon != null) {
            return _LetterUHexagon!!
        }
        _LetterUHexagon = ImageVector.Builder(
            name = "Outline.LetterUHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterUHexagon: ImageVector? = null

...
val MynaIcons.Outline.LetterJOctagon: ImageVector
    get() {
        if (_LetterJOctagon != null) {
            return _LetterJOctagon!!
        }
        _LetterJOctagon = ImageVector.Builder(
            name = "Outline.LetterJOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterJOctagon: ImageVector? = null

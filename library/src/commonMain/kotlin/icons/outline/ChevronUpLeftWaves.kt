...
val MynaIcons.Outline.ChevronUpLeftWaves: ImageVector
    get() {
        if (_ChevronUpLeftWaves != null) {
            return _ChevronUpLeftWaves!!
        }
        _ChevronUpLeftWaves = ImageVector.Builder(
            name = "Outline.ChevronUpLeftWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpLeftWaves: ImageVector? = null

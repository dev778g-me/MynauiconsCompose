...
val MynaIcons.Outline.EightHexagon: ImageVector
    get() {
        if (_EightHexagon != null) {
            return _EightHexagon!!
        }
        _EightHexagon = ImageVector.Builder(
            name = "Outline.EightHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _EightHexagon: ImageVector? = null

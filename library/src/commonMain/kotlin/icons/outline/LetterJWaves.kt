...
val MynaIcons.Outline.LetterJWaves: ImageVector
    get() {
        if (_LetterJWaves != null) {
            return _LetterJWaves!!
        }
        _LetterJWaves = ImageVector.Builder(
            name = "Outline.LetterJWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterJWaves: ImageVector? = null

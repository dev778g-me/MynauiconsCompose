...
val MynaIcons.Outline.AsteriskHexagon: ImageVector
    get() {
        if (_AsteriskHexagon != null) {
            return _AsteriskHexagon!!
        }
        _AsteriskHexagon = ImageVector.Builder(
            name = "Outline.AsteriskHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _AsteriskHexagon: ImageVector? = null

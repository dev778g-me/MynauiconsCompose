...
val MynaIcons.Outline.LetterEWaves: ImageVector
    get() {
        if (_LetterEWaves != null) {
            return _LetterEWaves!!
        }
        _LetterEWaves = ImageVector.Builder(
            name = "Outline.LetterEWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterEWaves: ImageVector? = null

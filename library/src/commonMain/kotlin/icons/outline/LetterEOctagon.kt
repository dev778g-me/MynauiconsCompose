...
val MynaIcons.Outline.LetterEOctagon: ImageVector
    get() {
        if (_LetterEOctagon != null) {
            return _LetterEOctagon!!
        }
        _LetterEOctagon = ImageVector.Builder(
            name = "Outline.LetterEOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterEOctagon: ImageVector? = null

...
val MynaIcons.Outline.ChevronDownLeftWaves: ImageVector
    get() {
        if (_ChevronDownLeftWaves != null) {
            return _ChevronDownLeftWaves!!
        }
        _ChevronDownLeftWaves = ImageVector.Builder(
            name = "Outline.ChevronDownLeftWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronDownLeftWaves: ImageVector? = null

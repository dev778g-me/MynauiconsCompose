...
val MynaIcons.Outline.LetterUWaves: ImageVector
    get() {
        if (_LetterUWaves != null) {
            return _LetterUWaves!!
        }
        _LetterUWaves = ImageVector.Builder(
            name = "Outline.LetterUWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterUWaves: ImageVector? = null

...
val MynaIcons.Outline.PercentageWaves: ImageVector
    get() {
        if (_PercentageWaves != null) {
            return _PercentageWaves!!
        }
        _PercentageWaves = ImageVector.Builder(
            name = "Outline.PercentageWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PercentageWaves: ImageVector? = null

...
val MynaIcons.Outline.LetterCWaves: ImageVector
    get() {
        if (_LetterCWaves != null) {
            return _LetterCWaves!!
        }
        _LetterCWaves = ImageVector.Builder(
            name = "Outline.LetterCWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterCWaves: ImageVector? = null

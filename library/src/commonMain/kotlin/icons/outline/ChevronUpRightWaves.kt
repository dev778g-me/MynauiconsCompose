...
val MynaIcons.Outline.ChevronUpRightWaves: ImageVector
    get() {
        if (_ChevronUpRightWaves != null) {
            return _ChevronUpRightWaves!!
        }
        _ChevronUpRightWaves = ImageVector.Builder(
            name = "Outline.ChevronUpRightWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ChevronUpRightWaves: ImageVector? = null

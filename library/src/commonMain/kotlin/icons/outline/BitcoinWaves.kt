...
val MynaIcons.Outline.BitcoinWaves: ImageVector
    get() {
        if (_BitcoinWaves != null) {
            return _BitcoinWaves!!
        }
        _BitcoinWaves = ImageVector.Builder(
            name = "Outline.BitcoinWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _BitcoinWaves: ImageVector? = null

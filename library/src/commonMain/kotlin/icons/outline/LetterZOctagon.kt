...
val MynaIcons.Outline.LetterZOctagon: ImageVector
    get() {
        if (_LetterZOctagon != null) {
            return _LetterZOctagon!!
        }
        _LetterZOctagon = ImageVector.Builder(
            name = "Outline.LetterZOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterZOctagon: ImageVector? = null

...
val MynaIcons.Outline.AsteriskOctagon: ImageVector
    get() {
        if (_AsteriskOctagon != null) {
            return _AsteriskOctagon!!
        }
        _AsteriskOctagon = ImageVector.Builder(
            name = "Outline.AsteriskOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _AsteriskOctagon: ImageVector? = null

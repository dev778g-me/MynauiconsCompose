...
val MynaIcons.Outline.LockOpenPassword: ImageVector
    get() {
        if (_LockOpenPassword != null) {
            return _LockOpenPassword!!
        }
        _LockOpenPassword = ImageVector.Builder(
            name = "Outline.LockOpenPassword",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LockOpenPassword: ImageVector? = null

...
val MynaIcons.Outline.PlusDiamond: ImageVector
    get() {
        if (_PlusDiamond != null) {
            return _PlusDiamond!!
        }
        _PlusDiamond = ImageVector.Builder(
            name = "Outline.PlusDiamond",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PlusDiamond: ImageVector? = null

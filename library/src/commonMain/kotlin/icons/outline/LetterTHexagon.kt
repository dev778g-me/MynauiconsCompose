...
val MynaIcons.Outline.LetterTHexagon: ImageVector
    get() {
        if (_LetterTHexagon != null) {
            return _LetterTHexagon!!
        }
        _LetterTHexagon = ImageVector.Builder(
            name = "Outline.LetterTHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterTHexagon: ImageVector? = null

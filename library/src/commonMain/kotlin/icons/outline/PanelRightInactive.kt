...
val MynaIcons.Outline.PanelRightInactive: ImageVector
    get() {
        if (_PanelRightInactive != null) {
            return _PanelRightInactive!!
        }
        _PanelRightInactive = ImageVector.Builder(
            name = "Outline.PanelRightInactive",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PanelRightInactive: ImageVector? = null

...
val MynaIcons.Outline.SearchOctagon: ImageVector
    get() {
        if (_SearchOctagon != null) {
            return _SearchOctagon!!
        }
        _SearchOctagon = ImageVector.Builder(
            name = "Outline.SearchOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SearchOctagon: ImageVector? = null

...
val MynaIcons.Outline.PlusOctagon: ImageVector
    get() {
        if (_PlusOctagon != null) {
            return _PlusOctagon!!
        }
        _PlusOctagon = ImageVector.Builder(
            name = "Outline.PlusOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _PlusOctagon: ImageVector? = null

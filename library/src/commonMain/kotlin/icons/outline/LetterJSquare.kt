...
val MynaIcons.Outline.LetterJSquare: ImageVector
    get() {
        if (_LetterJSquare != null) {
            return _LetterJSquare!!
        }
        _LetterJSquare = ImageVector.Builder(
            name = "Outline.LetterJSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterJSquare: ImageVector? = null

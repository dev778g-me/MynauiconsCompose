...
val MynaIcons.Outline.LetterWOctagon: ImageVector
    get() {
        if (_LetterWOctagon != null) {
            return _LetterWOctagon!!
        }
        _LetterWOctagon = ImageVector.Builder(
            name = "Outline.LetterWOctagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterWOctagon: ImageVector? = null

...
val MynaIcons.Outline.LetterMHexagon: ImageVector
    get() {
        if (_LetterMHexagon != null) {
            return _LetterMHexagon!!
        }
        _LetterMHexagon = ImageVector.Builder(
            name = "Outline.LetterMHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterMHexagon: ImageVector? = null

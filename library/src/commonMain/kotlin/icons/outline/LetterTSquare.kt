...
val MynaIcons.Outline.LetterTSquare: ImageVector
    get() {
        if (_LetterTSquare != null) {
            return _LetterTSquare!!
        }
        _LetterTSquare = ImageVector.Builder(
            name = "Outline.LetterTSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterTSquare: ImageVector? = null

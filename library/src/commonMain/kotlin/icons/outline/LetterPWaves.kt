...
val MynaIcons.Outline.LetterPWaves: ImageVector
    get() {
        if (_LetterPWaves != null) {
            return _LetterPWaves!!
        }
        _LetterPWaves = ImageVector.Builder(
            name = "Outline.LetterPWaves",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _LetterPWaves: ImageVector? = null

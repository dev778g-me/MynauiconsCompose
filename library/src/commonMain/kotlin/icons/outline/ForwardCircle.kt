...
val MynaIcons.Outline.ForwardCircle: ImageVector
    get() {
        if (_ForwardCircle != null) {
            return _ForwardCircle!!
        }
        _ForwardCircle = ImageVector.Builder(
            name = "Outline.ForwardCircle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ForwardCircle: ImageVector? = null
